...
for i in range(len(base_urls)):
        ...
        for submap in sitemap_urls:
            ...
            for index in range(len(article_urls)):
                ...
                if article_url.string.split('.com/')[1].split('/')[0]!="news":
                    print("NEWS TEST FAILED_____________________")
                    print('skipped')
                    continue
                ...
                if article_soup.find("h1"):
                    ...
                    print("H1 TEST FAILED_____________________")
                    print("skipped")
                    continue
                print(headline)
                if headline:
                    if is_eng(headline):
                        ...
                        print("LANGUAGE TEST FAILED_____________________")
                        print("skipped")
                if length%150==0:
                    break
            if length>=15000:
    ...
    #write data file
    dir_path = os.path.dirname(os.path.realpath(__file__))
    headline_data=open(dir_path+f"/raw-data/{url.split('.')[1]}_headlines.csv", 'w')
